        ...
        <div className="p-5 overflow-y-auto space-y-4 flex-1">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-slate-500 font-mono">
                    MSSV: <strong className="text-blue-600">{activeStudent.mssv}</strong> • Đã thu thập: <strong>{activeStudent.completedStations.length}/8</strong> trạm
                  </div>
                </div>
              </div>
              <button
          ...
          {tab === 'register' ? (
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-4 text-xs">
              <div className="p-3.5 bg-blue-50/80 border border-blue-200 rounded-2xl text-slate-700 text-xs leading-relaxed space-y-1">
