...
export const EventTimeline: React.FC<EventTimelineProps> = ({
  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      <div className="relative rounded-3xl overflow-hidden shadow-2xl border-2 border-orange-400/120 p-1 sm:p-2 text-white">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-slate-950/125 via-slate-900/75 to-slate-950/90 pointer-events-none" />
        ...
        <div className="relative z-10 backdrop-blur-[1px] rounded-2xl p-4 sm:p-8 overflow-hidden">
          ...
          <div className="relative z-10 my-6 sm:my-8 text-center space-y-4">
            ...
            <p className="max-w-2xl mx-auto text-orange-100 text-xs sm:text-sm leading-relaxed font-medium">
              Chủ Nhật, ngày <strong>27/9/2026</strong> tại Cơ sở chính ĐH Sài Gòn (273 An Dương Vương). Khám phá chuỗi <strong>22 hoạt động</strong> bùng nổ, điểm danh <strong>12 trạm NFC một chạm</strong> để hoàn thành Hộ chiếu điện tử và tham gia Gala Chung kết!
            </p>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <div>
            <h2 className="text-xl font-display font-black text-slate-900 flex items-center gap-2">
              ...
              <span>12 Trạm Điểm Danh Một Chạm (NFC / QR)</span>
            </h2>
            <p className="text-xs text-slate-600 font-medium mt-0.5">
              12 trạm điểm danh cốt lõi ngày hội theo Kế hoạch.
            </p>
          </div>
          <div className="bg-amber-100 border border-amber-300 text-amber-900 px-3 py-1 rounded-xl text-xs font-black self-start sm:self-auto flex items-center gap-1.5">
            ...
            <span>Chinh phục 12 trạm ngày hội để ghi dấu ấn vào Hộ Chiếu Điện Tử</span>
          </div>
        </div>
