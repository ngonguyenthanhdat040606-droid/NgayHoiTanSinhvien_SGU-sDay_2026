  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-orange-100 font-medium mt-0.5">
              Tất cả lượt chạm NFC và quét QR tại 12 trạm đều được cập nhật tức thì lên hệ cơ sở dữ liệu đám mây của Ban Tổ Chức.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-3xl border-2 border-orange-200 shadow-xs space-y-2">
          <div className="flex items-center justify-between text-slate-600 text-xs font-black uppercase">
            <span>Lượt Check-in 12 trạm</span>
        ...
        <div className="bg-white p-5 rounded-3xl border-2 border-orange-200 shadow-xs space-y-2">
          <div className="flex items-center justify-between text-slate-600 text-xs font-black uppercase">
            <span>Hoàn Thành 8/12 trạm</span>
        ...
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-display font-black text-base text-slate-900 flex items-center gap-2">
              ...
              <span>Tiến Độ Tham Gia Tại 12 trạm Ngày Hội SGU’s Day 2026</span>
            </h3>
          ...
          <table className="w-full text-left text-xs">
            <thead>
              <tr className="border-b border-slate-100 text-slate-400 font-bold uppercase text-[10px]">
                ...
                <th className="py-2.5 px-2 text-right">Tiến độ 12 trạm</th>
              </tr>
            </thead>
